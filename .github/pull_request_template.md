...
- [ ] Signed off (`git commit -s`) — contributions are licensed under Apache-2.0 (see CONTRIBUTING.md)
- [ ] Business code (`server/apps_business/`) stays behind `has_feature()` gates and never blocks monitoring
