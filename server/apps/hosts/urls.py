...
urlpatterns = [
    ...
    path("<uuid:host_id>/firewall/refresh/", views.host_firewall_refresh,
         name="host-firewall-refresh"),
    path("<uuid:host_id>/firewall/apply/", views.host_firewall_apply,
         name="host-firewall-apply"),
